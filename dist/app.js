...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _gravatar = __webpack_require__(159);
	...
	(0, _reactDom.render)(_react2['default'].createElement(_gravatar2['default'], null), appRoot);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _md = __webpack_require__(160);
	...
	var _email = __webpack_require__(165);
	...
	var Gravatar = function (_React$Component) {
	  ...
	  function Gravatar(props) {
	    ...
	    var _this = _possibleConstructorReturn(this, (Gravatar.__proto__ || Object.getPrototypeOf(Gravatar)).call(this, props));
	  ...
	  _createClass(Gravatar, [{
	    ...
	    value: function () {
	      function updateGravatar() {
	        this.setState({
	          src: 'http://gravatar.com/avatar/' + (0, _md2['default'])(this.state.email) + '?s=200'
	        });
	      }

	      return updateGravatar;
	    }()
	  }, {
	    key: 'updateEmail',
	    value: function () {
	    ...
	    value: function () {
	      function render() {
	        return _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(_avatar2['default'], { email: this.state.email, src: this.state.src }),
	          _react2['default'].createElement(_email2['default'], { fetchGravatar: this.updateGravatar.bind(this), handleEmailChange: this.updateEmail.bind(this) })
	        );
	      }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	(function(){
	  var crypt = __webpack_require__(161),
	      utf8 = __webpack_require__(162).utf8,
	      isBuffer = __webpack_require__(163),
	      bin = __webpack_require__(162).bin,
...
/***/ (function(module, exports, __webpack_require__) {
	    ...
	    value: function () {
	      function render() {
	        return _react2["default"].createElement(
	          ...
	          _react2["default"].createElement("input", { onChange: this.props.handleEmailChange, className: "form-control", style: {
	              width: 200
	            }, type: "text" }),
	          _react2["default"].createElement(
	            "button",
	            { onClick: this.props.fetchGravatar, className: "btn-success btn " },
	            "Fetch"
	          )
	        );
	      }
	...
	Email.propTypes = {
	  handleEmailChange: _react.PropTypes.func,
	  fetchGravatar: _react.PropTypes.func
	};
