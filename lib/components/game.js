...
export default class Game extends React.Component {
  ...
  // (this.state.currentPlayer == 1) ? this.updateFleetAndMapP1(finalmap,fleet) : this.updateFleetAndMapP2(finalmap,fleet)
  // absolutely no idea why the line above doesn't work in place of line 104
  // works perfectly fine with horizontalPlace...weird, it just doesn't like brackets when in the verticalPlace() method?
